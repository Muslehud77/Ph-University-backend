...
return result;
  ...
  throw new AppError(httpStatus.BAD_REQUEST,err?.message||"Could not update course")
...
const deleteFacultiesFromCourseFromDB = async (id: string, facultiesToRemove:Partial<TCourseFaculty>) => {
