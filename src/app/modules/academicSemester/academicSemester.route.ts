...
import { academicSemesterValidation, updateAcademicSemesterValidation } from './academicSemester.validation'
...
router.patch('/:id',validateRequest(updateAcademicSemesterValidation),AcademicSemesterControllers.updateSemester)
