...
export const hasConflict = (assignedSchedules : TAssignedSchedules, newSchedules:TNewSchedules,operation:string) => {
  ...
  console.log(assignedSchedules);
    ...
    for(const schedule of assignedSchedules){
          ...
          const newStartingTime = new Date(
            `1970-01-01T${newSchedules.startTime}`,
          );
          const newEndTime = new Date(
            `1970-01-01T${newSchedules.endTime}`,
          );
